  ...
  module Backends
    class Base
      ...
      class Config
        ...
        #  - :type, a Class object derived from SQL::Base that this will be passed
        #           to.
      ...
      # These are base classes for meta-information about
      # a database. As the library is decoupled from MySQL in
      # particular, they will be expanded to contain more base
      # class functionality.
      class Result
      end
