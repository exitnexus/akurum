...
module Akurum
  # A set of results from a query that returns only a paginated subset of
  # the total results. Contains extra information about paging and
  # whether there are more results.
  class Table::PagedResult < Table::Result
